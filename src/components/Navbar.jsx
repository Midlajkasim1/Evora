...
export default function Navbar() {
  ...
  const [lastClickedContact, setLastClickedContact] = useState(null);
  ...
  // Clear contact click state on page navigation
  useEffect(() => {
    const handlePopState = () => setLastClickedContact(null);
  ...
  return (
    <>
      ...
      <nav className="bottom-tab" aria-label="Mobile bottom navigation">
        <a href="/" onClick={() => setLastClickedContact(null)} className={`bottom-tab__item${pathname === '/' && !lastClickedContact ? ' active' : ''}`}>
          <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg>
          <span>Home</span>
        </a>
        <a href="tel:+18008362376" onClick={() => setLastClickedContact('call')} className={`bottom-tab__item${lastClickedContact === 'call' ? ' active' : ''}`}>
        ...
        <a href="https://wa.me/18008362376" onClick={() => setLastClickedContact('whatsapp')} className={`bottom-tab__item bottom-tab__whatsapp${lastClickedContact === 'whatsapp' ? ' active' : ''}`} aria-label="WhatsApp">
        ...
        <a href="mailto:hello@evora.ae" onClick={() => setLastClickedContact('email')} className={`bottom-tab__item${lastClickedContact === 'email' ? ' active' : ''}`}>
        ...
        <a href="/quote" onClick={() => setLastClickedContact('enquiry')} className={`bottom-tab__item${(pathname === '/quote' && !lastClickedContact) || lastClickedContact === 'enquiry' ? ' active' : ''}`}>
